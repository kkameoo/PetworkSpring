...
public class UserServiceImpl implements UserService {
	...
	public void updateUser(UserVo user) throws Exception {
	    UserVo existing = userMapper.selectUserById(user.getUserId());

	    if (user.getName() == null) user.setName(existing.getName());
	    if (user.getNickname() == null) user.setNickname(existing.getNickname());
	    if (user.getTelNumber() == null) user.setTelNumber(existing.getTelNumber());
